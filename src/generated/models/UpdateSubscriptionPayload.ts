 ...
 */
import type { UpdateSubscriptionPayloadSubscriptionsItem } from './UpdateSubscriptionPayloadSubscriptionsItem';
import type { SubscriptionFilter } from './SubscriptionFilter';
import type { SubscriptionAction } from './SubscriptionAction';
import type { UpdateSubscriptionPayloadWebhookHeaders } from './UpdateSubscriptionPayloadWebhookHeaders';
...
export interface UpdateSubscriptionPayload {
  ...
  subscriptions?: UpdateSubscriptionPayloadSubscriptionsItem[];
   ...
   * @nullable
   */
  webhook_headers?: UpdateSubscriptionPayloadWebhookHeaders;
  /** JSON stringified scheduler metadata used for schedule-based subscriptions */
  scheduler_job_metadata?: string;
}
