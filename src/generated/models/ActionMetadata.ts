...
export interface ActionMetadata {
  /** The conversation/channel ID where the reminder message should be sent */
  conversation_id?: string;
  /** Whether the message should be sent as a bot. If true, bot_user_id should be provided */
  send_as_bot?: boolean;
  /** The message text to send. Either message or from_message_id must be provided */
  message?: string;
