 ...
 */
import type { ListOwnedSubscriptionsDirection } from './ListOwnedSubscriptionsDirection';

export type ListOwnedSubscriptionsParams = {
  skip?: number;
  /**
   * Max number of results allowed per page is: **100**
   */
  limit?: number | null;
  direction?: ListOwnedSubscriptionsDirection;
  /**
