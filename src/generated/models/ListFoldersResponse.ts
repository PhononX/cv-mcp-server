 ...
 */
import type { ListFoldersResponseType } from './ListFoldersResponseType';
import type { ListFoldersResponseSortDirection } from './ListFoldersResponseSortDirection';
import type { ListFoldersResponseSortBy } from './ListFoldersResponseSortBy';
import type { Folder } from './Folder';

export interface ListFoldersResponse {
  /** Folder Type */
  type: ListFoldersResponseType;
  /** Return all folders tree */
  include_all_tree?: boolean;
  /** Workspace ID */
  workspace_id?: string;
  /** Sort order direction */
  sort_direction?: ListFoldersResponseSortDirection;
  /** Field to sort by */
  sort_by?: ListFoldersResponseSortBy;
  /** List of Folders */
  results?: Folder[];
}
