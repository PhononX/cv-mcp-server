 ...
 * @nullable
 */
export type ListSubscriptionsPaginationDirection =
  | (typeof ListSubscriptionsPaginationDirection)[keyof typeof ListSubscriptionsPaginationDirection]
  | null;

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ListSubscriptionsPaginationDirection = {
  older: 'older',
  newer: 'newer',
} as const;
