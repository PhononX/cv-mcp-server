...
export type ActionItemControllerListDirection =
  (typeof ActionItemControllerListDirection)[keyof typeof ActionItemControllerListDirection];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ActionItemControllerListDirection = {
  older: 'older',
  newer: 'newer',
} as const;
