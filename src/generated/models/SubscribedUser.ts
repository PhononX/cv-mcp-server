 ...
 */
import type { SubscribedUserSubscriptionsItem } from './SubscribedUserSubscriptionsItem';
import type { SubscriptionFilter } from './SubscriptionFilter';
import type { SubscriptionAction } from './SubscriptionAction';
import type { SubscribedUserWebhookHeaders } from './SubscribedUserWebhookHeaders';
...
export interface SubscribedUser {
  ...
  client_id: string;
  user_id: string;
  /** Array of subscription events or triggers (including "schedule" for time-based triggers) */
  subscriptions: SubscribedUserSubscriptionsItem[];
  /** Webhook URL to send the data */
  webhookURL?: string;
  subscription_filters?: SubscriptionFilter[];
  subscription_actions?: SubscriptionAction[];
  /** Custom HTTP headers forwarded on webhook deliveries for this subscription. */
  webhook_headers?: SubscribedUserWebhookHeaders;
}
