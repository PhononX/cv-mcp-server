 ...
 */
import type { SubFolderType } from './SubFolderType';
...
export interface SubFolder {
  ...
  /** List of Message IDs */
  message_ids?: string[];
  /** Ordered List of all folders in the path from root to this folder */
  path?: string[];
  /** Total count for all Nested Folders */
  total_nested_folders_count: number;
  /** Total count for all Nested Messages */
  total_nested_messages_count: number;
  /** Folder type */
  type: SubFolderType;
  /** Workspace ID where folder belongs to */
  workspace_id: string;
  created_at: string;
