 ...
 */
import type { ConversationUsersInput } from './ConversationUsersInput';
import type { Role } from './Role';

export interface AddConversationUsers {
  /** List of users to add to the conversation. (At least one of ids, emails, or phones is required) */
  users: ConversationUsersInput;
  role?: Role;
}
