 ...
 */
import type { SimplifiedLabelBehavior } from './SimplifiedLabelBehavior';
import type { SimplifiedLabelType } from './SimplifiedLabelType';
...
export interface SimplifiedLabel {
  ...
  name: string;
  /** Behavior */
  behavior: SimplifiedLabelBehavior;
  /** Type */
  type: SimplifiedLabelType;
  /** Creator ID */
  creator_guid: string;
  /** Workspace ID */
  space_guid?: string;
