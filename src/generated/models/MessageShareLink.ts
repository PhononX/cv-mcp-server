 ...
 */
import type { MessageShareLinkShareType } from './MessageShareLinkShareType';
import type { MessageShareLinkAccessType } from './MessageShareLinkAccessType';
import type { SpecifiedAccess } from './SpecifiedAccess';
import type { Message } from './Message';

export interface MessageShareLink {
  /** Identifier of the User who created the share/forward */
  created_by: string;
  /**
   * Message ID that has the share_link_id attached to
   * @nullable
   */
  ...
  share_type: MessageShareLinkShareType;
  /** What is the access type for the MessageShareLink */
  access_type: MessageShareLinkAccessType;
  /** List of Specified Access for the MessageShareLink */
  specified_access?: SpecifiedAccess[];
  /** Unique Identifier of share link */
  id: string;
  /** Conversation ID */
  conversation_id?: string;
  /** Link to Message Share Link */
  link: string;
  created_at: string;
  last_updated_at: string;
  end_access_at?: string;
  revoked_at?: string;
