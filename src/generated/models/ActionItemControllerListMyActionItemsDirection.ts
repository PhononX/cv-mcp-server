...
export type ActionItemControllerListMyActionItemsDirection =
  (typeof ActionItemControllerListMyActionItemsDirection)[keyof typeof ActionItemControllerListMyActionItemsDirection];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ActionItemControllerListMyActionItemsDirection = {
  older: 'older',
  newer: 'newer',
} as const;
