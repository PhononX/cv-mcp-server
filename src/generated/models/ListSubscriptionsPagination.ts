 ...
 */
import type { ListSubscriptionsPaginationDirection } from './ListSubscriptionsPaginationDirection';

export interface ListSubscriptionsPagination {
  /** @minimum 0 */
  skip?: number;
  /**
   * Max number of results allowed per page is: **100**
   * @minimum 1
   * @maximum 100
   * @nullable
   */
  limit?: number | null;
  /** @nullable */
  direction?: ListSubscriptionsPaginationDirection;
  /** ISO 8601 date string for cursor pagination */
  date?: string;
}
