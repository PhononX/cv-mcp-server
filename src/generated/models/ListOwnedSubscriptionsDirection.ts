...
export type ListOwnedSubscriptionsDirection =
  | (typeof ListOwnedSubscriptionsDirection)[keyof typeof ListOwnedSubscriptionsDirection]
  | null;

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ListOwnedSubscriptionsDirection = {
  older: 'older',
  newer: 'newer',
} as const;
