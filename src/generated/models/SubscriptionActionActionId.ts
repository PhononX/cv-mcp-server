 ...
 */
export type SubscriptionActionActionId =
  (typeof SubscriptionActionActionId)[keyof typeof SubscriptionActionActionId];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SubscriptionActionActionId = {
  run_ai_prompt: 'run_ai_prompt',
  send_channel_message_reminder: 'send_channel_message_reminder',
} as const;
