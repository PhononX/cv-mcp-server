 ...
 */
import type { SubscriptionActionActionId } from './SubscriptionActionActionId';
import type { SubscriptionActionEntityType } from './SubscriptionActionEntityType';
import type { ActionMetadata } from './ActionMetadata';

export interface SubscriptionAction {
  /** What is the action to perform */
  action_id: SubscriptionActionActionId;
  /** What is the entity_type to perform the action on (required when entity_id is provided) */
  entity_type?: SubscriptionActionEntityType;
  /** What is the entity_id to perform the action on (required when entity_type is provided) */
  entity_id?: string;
  /** Additional metadata for the action. Structure varies by entity_type */
