...
export type ActionItemControllerListIdsDirection =
  (typeof ActionItemControllerListIdsDirection)[keyof typeof ActionItemControllerListIdsDirection];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ActionItemControllerListIdsDirection = {
  older: 'older',
  newer: 'newer',
} as const;
