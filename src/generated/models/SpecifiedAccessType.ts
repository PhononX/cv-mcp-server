...
/**
 * What is the Specified access type for the MessageShareLink
 */
export type SpecifiedAccessType =
  (typeof SpecifiedAccessType)[keyof typeof SpecifiedAccessType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SpecifiedAccessType = {
  channel: 'channel',
  workspace: 'workspace',
