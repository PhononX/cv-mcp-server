 ...
 */
import type { ListMessagesResponseSortDirection } from './ListMessagesResponseSortDirection';
import type { ListMessagesFilter } from './ListMessagesFilter';
...
export interface ListMessagesResponse {
  ...
  sort_direction?: ListMessagesResponseSortDirection;
  /** Total number of records by applied filters (if any) */
  total: number;
  /** Results count (paginated results) */
  results_count: number;
  /** If there is more data available (omitted by pagination) */
