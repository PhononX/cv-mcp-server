 ...
 */
import type { GetFolderByIdDirection } from './GetFolderByIdDirection';

export type GetFolderByIdParams = {
  /**
   * Defines if the first level of the folder tree should be returned
   */
  include_first_level_tree?: boolean;
  /**
   * Direction of the results (newer or older)
   */
  direction?: GetFolderByIdDirection;
  /**
   * Return only Subfolders updated based on the date and direction (must inform include_first_level_tree = true)
   */
  date?: string | null;
};
