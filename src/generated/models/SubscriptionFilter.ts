 ...
 */
import type { SubscriptionFilterValue } from './SubscriptionFilterValue';
import type { SubscriptionFilterOperator } from './SubscriptionFilterOperator';

export interface SubscriptionFilter {
  /** What is the key to filter the data before sending to the webhook */
  key: string;
  /** Must match `operator`: use a string or number for "eq" and "ne"; use a non-empty array only for "in". */
  value: SubscriptionFilterValue;
  /** What is the operator to filter the data */
