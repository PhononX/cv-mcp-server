 ...
 */
import type { CreateMessageShareLinkShareType } from './CreateMessageShareLinkShareType';
import type { CreateMessageShareLinkAccessType } from './CreateMessageShareLinkAccessType';
import type { SpecifiedAccess } from './SpecifiedAccess';

export interface CreateMessageShareLink {
  /** Message ID that will be shared/forwarded */
  shared_message_id: string;
  /** What is the ShareType of the MessageShareLink */
  share_type: CreateMessageShareLinkShareType;
  /**
   * Message ID that will have the forward on it. Only required if share_type is forward.
   * @nullable
   */
  message_id?: string | null;
  /** What is the access type for the MessageShareLink */
  access_type: CreateMessageShareLinkAccessType;
  /**
   * List of Specified Access for the MessageShareLink
   * @nullable
   */
  specified_access?: SpecifiedAccess[] | null;
  /**
   * Date when the access to MessageShareLink ends
   * @nullable
   */
