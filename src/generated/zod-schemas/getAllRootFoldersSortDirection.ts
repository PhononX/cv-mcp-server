...
export type GetAllRootFoldersSortDirection =
  (typeof GetAllRootFoldersSortDirection)[keyof typeof GetAllRootFoldersSortDirection];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetAllRootFoldersSortDirection = {
  ASC: 'ASC',
  DESC: 'DESC',
} as const;
