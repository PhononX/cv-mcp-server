 ...
 */
import type { GetCountsGroupedByWorkspaceType } from './getCountsGroupedByWorkspaceType';

export type GetCountsGroupedByWorkspaceParams = {
  /**
   * Folder Type
   */
  type: GetCountsGroupedByWorkspaceType;
  /**
   * Workspace ID
   */
  workspace_id?: string;
