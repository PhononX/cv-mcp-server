...
export type CreateAIPromptResponseFormat =
  (typeof CreateAIPromptResponseFormat)[keyof typeof CreateAIPromptResponseFormat];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateAIPromptResponseFormat = {
  text: 'text',
  json: 'json',
} as const;
