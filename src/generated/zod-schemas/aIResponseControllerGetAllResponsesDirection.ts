...
export type AIResponseControllerGetAllResponsesDirection =
  (typeof AIResponseControllerGetAllResponsesDirection)[keyof typeof AIResponseControllerGetAllResponsesDirection];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AIResponseControllerGetAllResponsesDirection = {
  older: 'older',
  newer: 'newer',
} as const;
